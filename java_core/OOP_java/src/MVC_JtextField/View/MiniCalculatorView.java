package MVC_JtextField.View;

import MVC_JtextField.Controller.MiniCalculatorActionListener;
import MVC_JtextField.Model.MiniCalculatorModel;
...
public class MiniCalculatorView extends JFrame {
    ...
    public void init() {
        ...
        MiniCalculatorActionListener ac = new MiniCalculatorActionListener(this);
